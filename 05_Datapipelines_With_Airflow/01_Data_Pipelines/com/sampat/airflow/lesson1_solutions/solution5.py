...
def log_details(*args, **kwargs):
    ...
    #The link for the Airflow documentation on context variables has changed since the video was created.
    # Here is the new link: https://airflow.apache.org/macros.html
    #
    ds = kwargs['ds'] # kwargs[]
